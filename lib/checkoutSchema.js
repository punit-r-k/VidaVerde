...
export const SHIPPING_OPTIONS = [
  {
    id: FASTEST_SHIPPING_OPTION_ID,
    label: "Fastest Available Shipping",
    amountCents: 0,
    transitLabel: "Handed to the carrier on Wednesday using the fastest available service for your address.",
    carrierTransitLabel: "Live carrier estimate",
