...
export const SHIPPING_OPTIONS = [
  {
    ...
    label: "Shipping",
    amountCents: 0,
    transitLabel: "Handed to the carrier on Wednesday; estimated transit is 3–5 business days after carrier receipt.",
    carrierTransitLabel: "3–5 business days after carrier receipt",
    note: "The fastest eligible 3–5-business-day EasyPost rate is selected."
  },
  {
    id: EXPEDITED_SHIPPING_OPTION_ID,
    label: "Expedited Shipping",
    amountCents: 0,
    transitLabel: "Handed to the carrier on Wednesday; estimated transit is 1–3 business days after carrier receipt.",
