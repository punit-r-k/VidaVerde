...
const SHIPPING_PREORDER_ONLY_TIMING_NOTICE =
  `Pre-order timing is not guaranteed because fermentation and restock timing can vary. Once the order is ready, it is estimated to be handed to the carrier on the next configured shipping day (${SHIPPING_SCHEDULE_DAY_LABEL}). Same-day handoff requires readiness before ${SHIPPING_CUTOFF_LABEL}.`;
