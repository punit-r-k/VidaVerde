...
const SUNSET_PRODUCT_IMAGE = "/product-photos/Sunset.webp";
const ENDLESS_SUMMER_PRODUCT_IMAGE = "/product-photos/Endless-Summer.webp";
const CARIBBEAN_HEAT_PRODUCT_IMAGE = "/product-photos/Caribbean-Heat.webp";
const GREEN_KICK_PRODUCT_IMAGE = "/product-photos/Green-Kick.webp";
const HELL_YEAH_PRODUCT_IMAGE = "/product-photos/Hell-Yeah.webp";
...
const PRODUCT_CONTENT_BY_SKU = {
  ...
  VV3: {
    name: "Caribbean Heat",
    image: CARIBBEAN_HEAT_PRODUCT_IMAGE,
    profile: "Mild Spice",
    description:
  ...
  VV5: {
    ...
    image: GREEN_KICK_PRODUCT_IMAGE,
    profile: "Mild + Herbal",
    description:
