...
const FALLBACK_PRODUCTS = [
  {
    ...
    description: "Cabbage, beets, and carrots fermented with salt for bright, balanced crunch.",
    specs: [
      "Ferment: 28 days",
  ...
  },
  {
    ...
    name: "Caribean Heat",
    profile: "Green + Silky",
    description: "Cabbage and jalapeno deliver clean heat with a bright finish.",
    specs: [
      "Ferment: 18 days",
  ...
  },
  {
    ...
    description: "Cabbage and carrots fermented with salt for a clean, sunny profile.",
    specs: [
      "Ferment: 35 days",
  ...
  },
  {
    ...
    name: "Hell Yeah",
    profile: "Fire + Bold",
    description: "Raw fermented red jalapeno and habanero with onion.",
    specs: [
      "Ferment: 20 days",
