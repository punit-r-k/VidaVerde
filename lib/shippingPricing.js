...
export const SHIPPING_SCHEDULE_INTRO =
  "Wednesday is our weekly shipping day. Orders placed by 8 AM Central on Wednesday usually ship that day; later orders ship the following Wednesday.";
export const SHIPPING_SCHEDULE_STANDARD_LINE =
  "Shipping: estimated delivery in 3–5 business days after Wednesday shipment.";
export const SHIPPING_SCHEDULE_EXPEDITED_LINE =
  "Expedited Shipping: estimated delivery in 1–3 business days after Wednesday shipment.";
export const SHIPPING_SCHEDULE_EXPEDITED_NOTE =
  "Your final shipping charge and expected arrival are shown before payment.";
...
const NORMAL_ESTIMATE = {
  label: "Estimated delivery in 3–5 business days after Wednesday shipment.",
  deliveryEstimate: {
...
const EXPEDITED_ESTIMATE = {
  label: "Estimated delivery in 1–3 business days after Wednesday shipment.",
  deliveryEstimate: {
