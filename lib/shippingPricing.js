...
export const SHIPPING_SCHEDULE_STANDARD_LINE =
  "Shipping: the fastest EasyPost rate estimated to take 3–5 business days after carrier receipt.";
...
const NORMAL_ESTIMATE = {
  label: "Handed to the carrier on Wednesday; Shipping takes an estimated 3–5 business days after carrier receipt.",
