...
export function getLlmsText() {
  ...
  return [
    ...
    "- Vida Verde offers market pickup plus live fastest-carrier shipping. Shipping charges are carrier postage plus packaging, rounded up to the nearest dollar.",
