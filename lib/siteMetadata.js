...
export function getLlmsText() {
  ...
  return [
    ...
    "- Vida Verde offers market pickup plus live Shipping (3–5 business days) and Expedited Shipping (1–3 business days). Shipping charges are carrier postage plus packaging, rounded up to the nearest dollar.",
