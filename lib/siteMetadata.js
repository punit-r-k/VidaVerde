...
export function getLlmsText() {
  ...
  return [
    ...
    "- Vida Verde offers market pickup plus live Normal (3–5 business days) and Expedited (1–3 business days) shipping. Shipping charges are carrier postage plus packaging, rounded up to the nearest dollar.",
