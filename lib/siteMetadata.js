...
export const GOOGLE_REVIEW_FALLBACK_RATING = 5;
...
export function getLlmsText() {
  ...
  return [
    ...
    "- Paid in-stock orders completed before the Saturday cutoff can qualify for same-day Saturday pickup if inventory is still available.",
