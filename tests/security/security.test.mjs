...
const baseEnvironment = {
  ...
  EASYPOST_API_KEY: "EZTK_security_test_key",
  EASYPOST_WEBHOOK_SECRET: "security-test-webhook-secret",
  EASYPOST_LIVE_QUOTES_ENABLED: "true",
  SHIPPING_QUOTE_HMAC_SECRET: "security-test-shipping-quote-secret-32-bytes",
  ...
  EASYPOST_FROM_STREET1: "100 Test Runner Way",
  EASYPOST_FROM_CITY: "Richmond",
  EASYPOST_FROM_STATE: "TX",
  EASYPOST_FROM_ZIP: "77406",
